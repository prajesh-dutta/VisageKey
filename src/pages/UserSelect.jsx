...
const accounts = [
  {
    ...
    picture: "374ed1e4-481b-4074-a26e-6137657c6e35/download.jpg",
  },
  {
    id: "43332f46-89a4-435c-880e-4d72bb51149a",
    fullName: "Kiara",
    picture: "43332f46-89a4-435c-880e-4d72bb51149a/images.jpg",
  },
  {
  ...
  },
  {
    ...
    fullName: "Lee",
    picture: "/88421e2c-ca7a-4332-815f-6e12824e2d05/images.jpg",
  },
  {
    id: "0c2f5599-9296-4f94-97d5-e773043188ae",
    fullName: "Rohit Sharma",
    picture: "/0c2f5599-9296-4f94-97d5-e773043188ae/download.jpg",
  },
];
              ...
              {customUser && (
                <div className="relative">
                  ...
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="text-green-800 w-6 h-6 absolute top-1/2 -translate-y-1/2 right-[-32px] cursor-pointer"
                    onClick={() => {
                      setCustomUser(null);
          ...
          {!customUser && (
            <div className="flex flex-col items-center justify-center w-full mt-3">
              <label
                ...
                className="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:border-green-200 hover:bg-gray-100"
              >
