...
function Login() {
  ...
  const loadModels = async () => {
    // const uri = import.meta.env.DEV ? "/models" : "/VisageKey/models";
    const uri = "/models";
      ...
      const imgPath =
        tempAccount?.type === "CUSTOM"
          ...
          : // : import.meta.env.DEV
            ...
            // : `/VisageKey/temp-accounts/${tempAccount.picture}`;
            `/temp-accounts/${tempAccount.picture}`;
            ...
            {modelsLoaded ? (
              <>
                ...
                <button
                  ...
                  type="button"
                  className="flex justify-center items-center w-full py-2.5 px-5 mr-2 text-sm font-medium text-white bg-green-600 hover:bg-green-700 rounded-lg border border-gray-200 inline-flex items-center"
                >
                  Scan my face
                </button>
              </>
